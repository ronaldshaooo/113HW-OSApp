...
public class Gameplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // If Pool Cards < 10 (Can't Play Round)
    ...
    public void gameEnder(PlayerRoundInformation round1) {
        ...
        // TimerTask included 2s delay for player to see dealer score
    ...
    public void checkGameEnd(PlayerRoundInformation round1) {
        ...
        if (round1.getPlayerCount() > 21) {
            ...
            gameEnder(round1);
            // Dealer Bust
        } else if (round1.getDealerCount() > 21) {
            round1.setPlayerWin(true);
            gameEnder(round1);
            // Dealer 21 Win
        } else if (round1.getDealerCount() == 21) {
            ...
            gameEnder(round1);
            // Player 5 Hit Win
        } else if (round1.getHitCount()== 3 && round1.getPlayerCount() <= 21) {
            round1.setPlayerWin(true);
            gameEnder(round1);
            // Dealer 5 Hit Win
        } else if (round1.getDealerFiveCard()) {
            round1.setDealerWin(true);
            gameEnder(round1);
            // Player Count > Dealer Count
        } else if (round1.getPlayerCount() > round1.getDealerCount()) {
            round1.setPlayerWin(true);
            gameEnder(round1);
            // Player Count < Dealer Count
        } else if (round1.getPlayerCount() < round1.getDealerCount()) {
    ...
    public void gameStarter(ArrayList<String> cardPool, PlayerRoundInformation round1, TextView cardsLeft, ImageView cardImageP1, ImageView cardImageD2, ImageView cardImageP2, TextView player, TextView dealer){
        ...
        // Check for 21 Start (Instant Win)
        if (round1.getPlayerCardID().size() >= 2 && (
